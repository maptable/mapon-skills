...
DEFAULT_HOST = "https://mapon.ai/api/embed"
...
# Sent on every request: edge gateways (Cloudflare bot rules) challenge or
# block the stdlib's default "Python-urllib/x.y" User-Agent outright.
USER_AGENT = "mapview-cli"
